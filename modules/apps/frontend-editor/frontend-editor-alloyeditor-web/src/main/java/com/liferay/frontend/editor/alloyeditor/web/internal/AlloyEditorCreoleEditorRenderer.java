 ...
 */
@Component(property = "name=alloyeditor_creole", service = EditorRenderer.class)
public class AlloyEditorCreoleEditorRenderer
	extends AlloyEditorCreoleEditor implements EditorRenderer {
