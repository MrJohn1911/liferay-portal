...
public class PreferencesControllerUtil {
	...
	public static long _getOwnerId(long groupId, String scope, long userId)
		throws Exception {
	...
	public static WorkspacePreferences _getWorkspacePreferences(
	...
	public static void removeIndividualSegmentPreferences(
		...
		long ownerId = _getOwnerId(groupId, scope, userId);
