 ...
 */
@Component(property = "name=alloyeditor_bbcode", service = EditorRenderer.class)
public class AlloyEditorBBCodeEditorRenderer
	extends AlloyEditorBBCodeEditor implements EditorRenderer {
