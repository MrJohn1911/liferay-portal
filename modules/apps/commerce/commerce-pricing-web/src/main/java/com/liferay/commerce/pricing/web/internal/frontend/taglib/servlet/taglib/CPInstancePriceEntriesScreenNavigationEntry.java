...
public class CPInstancePriceEntriesScreenNavigationEntry
	...
	public String getCategoryKey() {
		return _cpInstancePriceEntriesScreenNavigationCategory.getCategoryKey();
	}
	...
	public String getLabel(Locale locale) {
		return _cpInstancePriceEntriesScreenNavigationCategory.getLabel(locale);
	}

	@Override
	public String getScreenNavigationKey() {
		return _cpInstancePriceEntriesScreenNavigationCategory.
	...
	@Reference(
		target = "(component.name=com.liferay.commerce.pricing.web.internal.frontend.taglib.servlet.taglib.CPInstancePriceEntriesScreenNavigationCategory)"
	)
	private ScreenNavigationCategory
		_cpInstancePriceEntriesScreenNavigationCategory;
