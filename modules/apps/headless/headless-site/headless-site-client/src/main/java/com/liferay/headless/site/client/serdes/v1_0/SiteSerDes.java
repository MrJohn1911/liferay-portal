...
public class SiteSerDes {
	...
	public static String toJSON(Site site) {
		...
		if (site.getParentSiteERC() != null) {
			...
			sb.append(_escape(site.getParentSiteERC()));
	...
	public static Map<String, String> toMap(Site site) {
		...
		if (site.getParentSiteERC() == null) {
			map.put("parentSiteERC", null);
		}
		else {
			map.put("parentSiteERC", String.valueOf(site.getParentSiteERC()));
		}
	...
	public static class SiteJSONParser extends BaseJSONParser<Site> {
		...
		protected boolean parseMaps(String jsonParserFieldName) {
			...
			else if (Objects.equals(jsonParserFieldName, "parentSiteERC")) {
				return false;
			}
		...
		protected void setField(
			...
			if (Objects.equals(jsonParserFieldName, "active")) {
				...
				if (jsonParserFieldValue != null) {
					site.setParentSiteERC((String)jsonParserFieldValue);
				}
			}
			else if (Objects.equals(jsonParserFieldName, "templateKey")) {
				if (jsonParserFieldValue != null) {
